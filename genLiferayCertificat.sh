...
openssl req -x509 -newkey rsa:4096 -keyout ./resources-container/liferay/files/ssl/private.key -out ./resources-container/liferay/files/ssl/certificate.pem -days 365 -nodes -subj /CN=$liferayDomain
