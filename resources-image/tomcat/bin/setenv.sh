...
# DATASOURCE
CATALINA_OPTS="$CATALINA_OPTS -DJAVA_LCP_SECRET_DATABASE_USER=$LCP_SECRET_DATABASE_USER"
CATALINA_OPTS="$CATALINA_OPTS -DJAVA_LCP_SECRET_DATABASE_PASSWORD=$LCP_SECRET_DATABASE_PASSWORD"
...
# Test
CATALINA_OPTS="$CATALINA_OPTS -DJAVA_VAR_ENV_1=$VAR_ENV_1"
